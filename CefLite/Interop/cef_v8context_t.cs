...
namespace CefLite.Interop
{
    ...
    public unsafe class CefV8Context : ObjectFromCef<cef_v8context_t, CefV8Context>
    {
        private CefV8Context(IntPtr ptr, bool addref = true) : base(ptr, addref) { }
        static public CefV8Context FromNative(cef_v8context_t* ptr)
            => FromNative((IntPtr)ptr, (p2) => new CefV8Context(p2));

        static public CefV8Context FromNativeReturn(cef_v8context_t* ptr)
            => FromNative((IntPtr)ptr, (p2) => new CefV8Context(p2,false));

        static public CefV8Context FromNative(IntPtr ptr)
            => FromNative(ptr, (p2) => new CefV8Context(p2));
        public cef_v8context_t* FixedPtr => (cef_v8context_t*)Ptr;

        static public implicit operator CefV8Context(cef_v8context_t* ptr) => FromNative(ptr);
        ...
        static public CefV8Context GetCurrent()
        {
            ...
            if (ctx == null)
                return null;
            //TODO:find all cases need FromNativeReturn
            return CefV8Context.FromNativeReturn(ctx);
        }
        ...
        public CefV8Value Eval(string code)
        {
            ...
            CefV8Value res = CefV8Value.FromNative(result);
            CefV8Exception err = CefV8Exception.FromNative(exception);
    ...
    public unsafe class CefV8Handler : ObjectFromNet<cef_v8handler_t, CefV8Handler>
    {
            ...
            (IntPtr self, cef_string_t* name, cef_v8value_t* obj, size_t argcount, cef_v8value_t** args, ref cef_v8value_t* retval, cef_string_t* error) =>
        {
            ...
            try
            {
                ...
                {
                    arglist.Add(CefV8Value.FromNative(args[i]));
                }
    ...
    public unsafe class CefV8Exception : ObjectFromCef<cef_v8exception_t, CefV8Exception>
    {
        private CefV8Exception(IntPtr ptr) : base(ptr) { }
        static public CefV8Exception FromNative(cef_v8exception_t* ptr)
            => FromNative((IntPtr)ptr, (p2) => new CefV8Exception(p2));
        static public CefV8Exception FromNative(IntPtr ptr)
           => FromNative(ptr, (p2) => new CefV8Exception(p2));
        public cef_v8exception_t* FixedPtr => (cef_v8exception_t*)Ptr;

        static public implicit operator CefV8Exception(cef_v8exception_t* ptr) => FromNative(ptr);
