...
namespace CefLite.Interop
{
	...
	public unsafe partial class CefListValue : FixedPointer<cef_list_value_t, CefListValue>
	{
		...
		{
			cef_list_value_t* ptr = (cef_list_value_t*)intptr;
			var _typed_release = Marshal.GetDelegateForFunctionPointer<GetInt32Handler>(ptr->brc.release);
			_typed_release(intptr);
		}

		private CefListValue(IntPtr ptr) : base(ptr) { }

		//static public CefListValue FromInArg(IntPtr ptr)
		//{
		//    if (ptr == IntPtr.Zero) return null;
		//    return new CefListValue(ptr);
		//}
		//static public CefListValue FromInArg(cef_list_value_t* ptr)
		//{
		//    if (ptr == null) return null;
		//    return new CefListValue((IntPtr)ptr);
		//}

		static public CefListValue FromOutVal(IntPtr ptr)
		{
			if (ptr == IntPtr.Zero) return null;
			CefListValue lv = new CefListValue(ptr);
			return lv;
		}
